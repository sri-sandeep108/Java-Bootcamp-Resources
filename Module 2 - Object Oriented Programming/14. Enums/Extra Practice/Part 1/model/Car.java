...
public class Car {
    ...
    private static final int MAX_PRICE = 200000;

    public enum BodyType {
        SEDAN, COUPE, HATCHBACK, SUV, TRACK, VAN
    }
    ...
    public void setMake(String make) {
        if (make == null || make.isBlank())
            throw new IllegalArgumentException("Make cannot be blank or null");
        this.make = make;
    }
    ...
    public void setModel(String model) {
        if (model == null || model.isBlank())
            throw new IllegalArgumentException("Model cannot be blank or null");
        this.model = model;
    }
